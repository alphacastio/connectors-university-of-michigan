...
post_data = {'table': '19', 'year': start_year, 'qorm': 'M', 'order': 'asc', 'format': 'Comma-Separated (CSV)'}
...
# dataset_name = 'Labour & Income - USA - University of Michigan - Change in Likelihood of Comfortable Retirement'
...
alphacast.datasets.dataset(8504).upload_data_from_df(df, 
